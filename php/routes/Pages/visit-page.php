      ...
      <section>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            ...
            <input type="text" name="last_name" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-[#003673] focus:outline-none" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');" required>
          </div>
          <div>
            <label class="block text-sm font-semibold mb-1">First Name <span class="text-red-500">*</span></label>
            <input type="text" name="first_name" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-[#003673] focus:outline-none" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');" required>
          </div>
          <div>
            <label class="block text-sm font-semibold mb-1">Middle Name <span class="text-red-500">*</span></label>
            <input type="text" name="middle_name" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-[#003673] focus:outline-none" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');">
          </div>
        </div>
    ...
    <input id="selfie-photo-path" name="selfie_photo_path" type="hidden" required />
      ...
      <section>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input type="tel" name="contact_number" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-[#003673] focus:outline-none" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="11" pattern="[0-9]{11}" required>
          </div>
          <div>
        ...
        <div id="vehicle-fields" class="hidden">
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              ...
              <input type="text" name="vehicle_brand" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-[#003673] focus:outline-none" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');">
            </div>
            <div>
              <label class="block text-sm font-semibold mb-1">Vehicle Type</label>
              <input type="text" name="vehicle_type" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-[#003673] focus:outline-none" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');">
            </div>
            <div>
              <label class="block text-sm font-semibold mb-1">Vehicle Color</label>
              <input type="text" name="vehicle_color" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-[#003673] focus:outline-none" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');">
            </div>
          </div>
      ...
      <section>
        ...
        <div class="mb-4">
          ...
          <input type="text" name="contact_personnel" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-[#003673] focus:outline-none" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');" required>
