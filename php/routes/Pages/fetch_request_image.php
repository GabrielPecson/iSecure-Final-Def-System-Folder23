...
if ($type === 'selfie') {
    $file_path = __DIR__ . 'www.isecured.online/php/Routes/Pages/uploads/selfies/' . $filename;
} else {
    $file_path = __DIR__ . 'www.isecured.online/php/Routes/Pages/uploads/ids/' . $filename;
}
