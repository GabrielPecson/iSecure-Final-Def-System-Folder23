...
if ($type === 'selfie') {
    $file_path = __DIR__ . 'www.isecured.online/iSecure-Final-Def-System-Folder/php/Routes/Pages/uploads/selfies/' . $filename;
} else {
    $file_path = __DIR__ . 'www.isecured.online/iSecure-Final-Def-System-Folder/php/Routes/Pages/uploads/ids/' . $filename;
}
