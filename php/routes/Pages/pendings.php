            ...
            <tr data-id="<?= $req['id'] ?>">
              ...
              <td>
                <button class="btn btn-primary btn-sm view-btn"
                  ...
                  data-date="<?= htmlspecialchars($req['visit_date'] ?? '') ?>"
                  data-time="<?= htmlspecialchars($req['visit_time'] ?? '') ?>"
...
function showConfirmModal(message, callback, title = 'Confirm') {
  ...
  document.getElementById("alertModalFooter").innerHTML = `
    ...
    <button type="button" class="btn btn-primary" id="alertModalConfirmBtn">OK</button>
  `;
...
function handleDecision(action) {
  ...
  const form = document.createElement('form');
  form.method = 'POST';
  form.action = 'approve_visitation_request.php';
...
function handleCancel() {
  const id = document.getElementById("modalRequestId").value;
  requestModal.hide();
  showConfirmModal("Are you sure you want to cancel this approved visitation request? This will remove the visitor and vehicle entries from the system.", (confirmed) => {
    if (confirmed) {
      submitForm('cancel_visitation_request.php', id);
    }
  });
}
...
document.addEventListener("click", (e) => {
  if (e.target.classList.contains("cancel-btn")) {
    ...
    showConfirmModal(`Are you sure you want to cancel the visitation request for ${name}? This will remove the visitor and vehicle entries from the system.`, (confirmed) => {
      if (confirmed) {
        submitForm('cancel_visitation_request.php', id);
      }
    });
