...
<div id="addUserModal" class="modal" aria-hidden="true">
  <div class="modal-content form-modal">
    ...
    <div id="add-user-error-message" class="error-message" style="color: red; text-align: center; margin-bottom: 10px;"></div>

    <form autocomplete="off" id="addUserForm" action="add_user.php" method="POST" novalidate>
...
<div id="editUserModal" class="modal" aria-hidden="true">
  <div class="modal-content form-modal">
    ...
    <form autocomplete="off" id="editUserForm" action="edit_user.php" method="POST" novalidate>
