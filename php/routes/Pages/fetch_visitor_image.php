...
try {
    ...
    if ($row) {
        ...
        if ($type === 'id') {
            $full_path = __DIR__ . 'www.isecured.online/php/Routes/Pages/uploads/ids/' . $file_path;
        } else {
            $full_path = __DIR__ . 'www.isecured.online/php/Routes/Pages/uploads/selfies/' . $file_path;
        }
