...
try {
    ...
    if ($row) {
        ...
        if ($type === 'id') {
            $full_path = __DIR__ . 'var/www/html/iSecure-Final-Def-System-Folder/php/Routes/Pages/uploads/ids/' . $file_path;
        } else {
            $full_path = __DIR__ . 'var/www/html/iSecure-Final-Def-System-Folder/php/Routes/Pages/uploads/selfies/' . $file_path;
        }
