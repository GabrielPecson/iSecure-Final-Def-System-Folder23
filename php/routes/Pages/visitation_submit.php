...
try {
    ...
    if ($success) {
        // Set a success message in the session to display on the visit page
        $_SESSION['notification_message'] = 'Visitation request submitted successfully!';
    ...
    // Set an error message in the session to display on the visit page
    $_SESSION['notification_message'] = 'Visitation request failed: ' . $e->getMessage();
