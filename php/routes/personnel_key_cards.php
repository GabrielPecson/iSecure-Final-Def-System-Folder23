...
// Fetch all visitors for selection (those currently 'Inside' based on time_in/time_out)
$stmt = $pdo->query("SELECT id, first_name, last_name FROM visitors WHERE time_in IS NOT NULL AND time_out IS NULL");
